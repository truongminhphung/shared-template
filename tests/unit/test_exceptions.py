...
class TestResourceNotFoundHandler:
    ...
    async def test_handler_with_different_resource_types(self):
        ...
        async def test_endpoint(resource_type: str, resource_id: int):
            raise ResourceNotFound(entity_name=resource_type, entity_id=resource_id)
...
class TestDuplicateResourceHandler:
    ...
    async def test_handler_returns_409_status(self):
        ...
        async def test_endpoint():
            raise DuplicateResource(
                entity_name="User", field_name="email", field_value="test@example.com"
            )
    ...
    async def test_handler_with_different_fields(self):
        ...
        async def test_endpoint(field: str):
            raise DuplicateResource(
                entity_name="User", field_name=field, field_value="testvalue"
            )
...
class TestValidationErrorHandler:
    ...
    @pytest.mark.parametrize(
        "exception_instance, expected_message",
        [
            (
    ...
    async def test_handler_variations(
        self, exception_instance: ValidationError, expected_message: str
    ):
...
class TestExceptionAttributes:
    ...
    def test_validation_error_attributes(self):
        ...
        # Act
        exception = ValidationError(field="username", message="Username is required")
